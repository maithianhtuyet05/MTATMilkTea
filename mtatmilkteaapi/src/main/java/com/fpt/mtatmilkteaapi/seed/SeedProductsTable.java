...
public class SeedProductsTable {
    ...
    public static void insertData() {
        ...
        if (count == 0) {
            ...
            Product product01 = new Product("P0882021035821","Trà Đào Đá Xay", "Peach Tea", "https://res.cloudinary.com/fpt-aptech-mtat/image/upload/v1628410434/product/tradaoxay.png", "tradaoxay",
                    65000, category04, sizeOptions01, addOptions01);

            // Insert Product2
            Product product02 = new Product("P0882021035822","Trà Vải Tươi Dầm", "Ice Shaken Lychee Tea", "https://res.cloudinary.com/fpt-aptech-mtat/image/upload/v1628411118/product/travai.png", "travai",
            ...
            Product product03 = new Product("P0882021035823","Trà Sữa Phúc Long", "Phuc Long Tea Latte", "https://res.cloudinary.com/fpt-aptech-mtat/image/upload/v1628411720/product/phuclong.png", "phuclong",
            ...
            Product product04 = new Product("P0882021035824","Trà Đào Phúc Long", "Phuc Long Peach Tea", "https://res.cloudinary.com/fpt-aptech-mtat/image/upload/v1628411771/product/tradao.png", "tradao",
            ...
            Product product05 = new Product("P0882021035825","Hồng Trà Sữa", "Phuc Long Black Milk Tea", "https://res.cloudinary.com/fpt-aptech-mtat/image/upload/v1628411720/product/phuclong.png", "phuclong",
                    50000, category01, sizeOptions03, addOptions05);

            // Insert Product6
            Product product06 = new Product("P0882021035826","Trà Ô Long Sữa", "Oolong Milk Tea", "https://res.cloudinary.com/fpt-aptech-mtat/image/upload/v1628411720/product/phuclong.png", "phuclong",
                    50000, category01, sizeOptions03, addOptions05);

            // Insert Product7
            Product product07 = new Product("P0882021035827","Trà Đào Sữa", "Peach Milk Tea", "https://res.cloudinary.com/fpt-aptech-mtat/image/upload/v1628411720/product/phuclong.png", "phuclong",
            ...
            Product product08 = new Product("P0882021035828","Cà Phê Espresso", "Espresso Coffee", "https://res.cloudinary.com/fpt-aptech-mtat/image/upload/v1628412575/product/espresso.png", "espresso",
            ...
            Product product09 = new Product("P0882021035829","Cà Phê Latte", "Latte Coffee", "https://res.cloudinary.com/fpt-aptech-mtat/image/upload/v1628412981/product/latte.png", "latte",
                    50000, category05, sizeOptions06, addOptions07);

            //Insert Snack
            //Insert snack01
            Category category02 = categoryRepository.findById(2L).get();
            Product snack01 = new Product("P0882021035830", "Hạt Điều Rang Củi Tỏi Ớt - Lon", "chilli Garlic Cashew-Can", "https://res.cloudinary.com/fpt-aptech-mtat/image/upload/v1628675856/product/dieutuoi.png", "dieutuoi",
                    75000, category02, null, null);

            //Insert snack02
            Product snack02 = new Product("P0882021035831", "Hạt Điều Rang Củi Tỏi Ớt - Gói", "chilli Garlic Cashew-Bag", "https://res.cloudinary.com/fpt-aptech-mtat/image/upload/v1628675965/product/dieutuoigiay.png", "dieutuoigiay",
                    26000, category02, null, null);

            //Insert snack03
            Product snack03 = new Product("P0882021035832", "Hạt Điều Rang Củi (Vỏ Lụa) - Lon", "Cashew-Can", "https://res.cloudinary.com/fpt-aptech-mtat/image/upload/v1628676146/product/dieu.png", "dieu",
                    78000, category02, null, null);

            //Insert snack04
            Product snack04 = new Product("P0882021035833", "Hạt Điều Rang Củi (Vỏ Lụa) - Gói - Lon", "Cashew-Bag", "https://res.cloudinary.com/fpt-aptech-mtat/image/upload/v1628676309/product/dieutuoivolua.png", "dieutuoivolua",
                    27000, category02, null, null);

            //Insert Product
            //Insert product01
            Category category03 = categoryRepository.findById(3L).get();
            Product pd01 = new Product("P0882021035834", "Cà Phê King + Fin Nhôm", "Filter Coffe King", "https://res.cloudinary.com/fpt-aptech-mtat/image/upload/v1628690333/product/king.png", "king",
                    107000, category03, null, null);

            //Insert product02
            Product pd02 = new Product("P0882021035834", "Cà Phê Robusa + Fin Nhôm", "Filter Coffe Robusa", "https://res.cloudinary.com/fpt-aptech-mtat/image/upload/v1628690415/product/robusa.png", "robusa",
                    87000, category03, null, null);

            //Insert product03
            Product pd03 = new Product("P0882021035835", "Cà Phê Moka Blend + Fin Nhôm", "Filter Coffe Moka Blend", "https://res.cloudinary.com/fpt-aptech-mtat/image/upload/v1628690464/product/mokablend.png", "mokablend",
                    93000, category03, null, null);

            //Insert product04
            Product pd04 = new Product("P0882021035836", "Cà Phê Moka + Fin Nhôm", "Filter Coffe Moka", "https://res.cloudinary.com/fpt-aptech-mtat/image/upload/v1628690544/product/moka.png", "moka",
                    116000, category03, null, null);

            //Insert product05
            Product pd05 = new Product("P0882021035837", "Cà Phê Royal Special + Fin Nhôm", "Filter Coffe Royal Special", "https://res.cloudinary.com/fpt-aptech-mtat/image/upload/v1628690668/product/royal.png", "royal",
                    103000, category03, null, null);

            //Insert product06
            Product pd06 = new Product("P0882021035838", "Cà Phê Royal Smooth", "Filter Coffe Royal Smooth", "https://res.cloudinary.com/fpt-aptech-mtat/image/upload/v1628690777/product/smooth.png", "smooth",
                    97000, category03, null, null);

            //Insert product07
            Product pd07 = new Product("P0882021035838", "Cà Phê Rich", "Filter Coffe Rich", "https://res.cloudinary.com/fpt-aptech-mtat/image/upload/v1628691163/product/rich.png", "rich",
